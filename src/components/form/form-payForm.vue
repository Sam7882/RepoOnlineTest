	...
	<uni-forms ref="form" :model="formData" :rules="formRules" label-position="top">
		...
		<view class="pay-order-container">
			...
			<uni-forms-item class="pay-page-content-item coupon-wrapper" name="payAmount">
				...
				<view class="coupon-wrapper-input-container">
					<uni-easyinput type="text" :trim="true" v-model="couponCode" :placeholder="$t('wallet.couponCodePlaceholder')"
						class="input-box" />
					<button type="button" class="confirm-btn" @click="applyCoupon">{{ $t('common.confirm') }}</button>
				</view>
			</uni-forms-item>
		...
		<view class="pay-page-content-item-cardbottom">
			...
			<uni-forms-item class="pay-page-content-item-cardRight" name="cardCvv" :label="$t('wallet.securityCode')"
				label-width="150">
				<uni-easyinput type="number" placeholder="cvv" v-model="formData.cardCvv" class="pay-page-content-item-input"
		...
		<!-- 郵遞區號 -->
		<uni-forms-item class="pay-page-content-item" :label="$t('common.postalCode')" label-width="150" name="postalCode"
			required>
			<view class="pay-page-content-item-input-container">
