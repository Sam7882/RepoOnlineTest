...
import { toPlayIndex, toCreatorHome, toPostUpload } from '@/utils/routers';
...
const openConfirmPopUp = () => {
	confirmPopUp.value.open({
		...
		onConfirm: () => {
			console.log('捨棄')
			console.log("🚀 ~ openConfirmPopUp ~ isSchedulePost.value:", isSchedulePost.value)
...
const isSchedulePost = ref(false)
onLoad((options: any) => {
