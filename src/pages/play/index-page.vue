	...
	<view class="play-container">
		...
		<view class="play-swiper-container">
			<ml-swiper-v3-new v-if="list.length > 0" :list="list" :startIndex="startIndex" :force="force" :touch="touch"
				...
				@loadedmetadata="loadedmetadata" @onloadeddata="onloadeddata" @onerror="error" @noTrigger="noTrigger"
				@onmute="onmute" ref="mlSwiper">
				<!-- #ifndef H5 -->
				...
				<template #bottom="{ item }">
					<!-- 圖片用開啟類全螢幕 swiper -->
					<!-- TODO: 圖片全螢幕 需調整 -->
					<view class="bottom-tool-conainer-wrapper-avatar-container" v-if="item?.imgList?.length > 0">
